...
////Get Purchase History of a supplier
	...
	public int InsertIntoAccountPayableOfSupplier(String dateFormat, String dealerName, String dealerId, String paymentType, float amount) {
		String query = "INSERT INTO accountpayable(date,supplier_Id,supplier_Name,type,amount)"
				+ "VALUES" + "('"+dateFormat+"', '"+dealerName+"', '"+dealerId+"', '"+paymentType+"', '"+amount+"')";
		return conn.queryHolder(query);
	...
	/////////////////////////////////// Account Receivable ////////////////////////////////////////
	public int InsertIntoAccountReceivableOfCustomer(String dateFormat, String dealerName, String dealerId, String paymentType, float amount) {
		String query = "INSERT INTO accountsrecievable(date,customer_Id,customer_Name,type,amount)"
				+ "VALUES" + "('"+dateFormat+"', '"+dealerName+"', '"+dealerId+"', '"+paymentType+"', '"+amount+"')";
		return conn.queryHolder(query);
