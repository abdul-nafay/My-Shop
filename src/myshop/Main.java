...
import myshop.view.AddPaymentWindowController;
...
public class Main extends Application {
	...
	public static void showAllSuppliers() throws IOException{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("view/AllSuppliersView.fxml"));
		BorderPane supplierView = loader.load();
		mainLayout.setCenter(supplierView);
	}
	
	public static void showAllCustomers() throws IOException{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("view/AllCustomersView.fxml"));
	...
	public static void showAllProducts() throws IOException{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("view/AllProductView.fxml"));
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void showAddPaymentWindow() throws IOException{
			...
			AddPaymentWindowController controller = (AddPaymentWindowController) loader.getController();
			Stage addDialogStage = new Stage();
